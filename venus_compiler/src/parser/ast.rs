...
pub enum Node {
    ...
    /// a UI component, an int, an if statement, a for loop — they are ALL Variables.
    Variable(Variable),
    
    /// Assignment (bare mutation `x = 5`, not declaration)
...
// Control Flow and statements are now Variables!
